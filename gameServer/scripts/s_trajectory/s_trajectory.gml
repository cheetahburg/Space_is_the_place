function s_trajectory(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
	...
	buffer_write(com_server.server_buffer,buffer_string,_item);
