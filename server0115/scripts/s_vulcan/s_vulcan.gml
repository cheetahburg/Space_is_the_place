function s_vulcan(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	buffer_write(com_server.server_buffer,buffer_string,"vulcan");
