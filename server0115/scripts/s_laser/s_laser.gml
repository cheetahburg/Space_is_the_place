function s_laser(argument0, argument1, argument2, argument3, argument4, argument5) {
	...
	var _dir=argument5;
	var _speed=0;
	var _image_angle=argument5;

	//var _creator_username=argument6;
	...
	buffer_write(com_server.server_buffer,buffer_string,"laser");
